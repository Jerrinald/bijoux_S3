...
<body>
	...
	</div><div class="cart-btns" style="width:70%; margin-left: 150px;">
		<div class="continue__shopping">
	        	<a href="ajouter.php">Gestion produit</a>
	    </div></div>
		...
		if(!empty($_SESSION["shopping_cart"])){
			...
			foreach($_SESSION["shopping_cart"] as $keys => $values){
				...
				<tr>
					...
					<td><a href="diamant.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
				</tr><br><br>
				<?php
