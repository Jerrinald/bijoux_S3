          ...
          <ul class="glide__slides">
            <li class="glide__slide">
              <div class="hero__center">
                <div class="hero__left">
                  ...
                  <h1 class="">Trouvez ici les meilleurs Bijoux !</h1>
                  <p>Les dernières tendances à un prix imbattable sur le marché sont disponible ICI !</p>
                  <a href="cart2.php"><button class="hero__btn">ACHETEZ MAINTENANT</button></a>
                </div>
            ...
            <li class="glide__slide">
              <div class="hero__center">
                <div class="hero__left">
                  <span>NOUVEAU !</span>
                  <h1>DES BIJOUX CONÇUS POUR VOUS!</h1>
                  <p>Les dernières tendances à un prix imbattable sur le marché sont disponible ICI !</p>
                  <a href="cart2.php"><button class="hero__btn">ACHETEZ MAINTENANT</button></a>
                </div>
                <div class="hero__right">
      ...
      <section id="collection" class="section collection">
        <div class="collection__container" data-aos="fade-up" data-aos-duration="1200">
          ...
          <div class="collection__box">
            ...
            <div class="collection__content">
              <div class="collection__data">
                <span>Assemblez votre propre bague</span>
                <h1>ANNEAUX</h1>
                ...
                <li class="glide__slide">
                  <div class="product">
                    <div class="product__header">
                      <img src="/images/products/iPhone/iphone6.jpeg" alt="product">s
                    </div>
